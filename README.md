...
1. The core features of Node.js and Express and why they are useful.
    ...
    Node allows us to write JS directly onto the server. Also, being Single-Threaded to remove the complexity in handling multiple threads.

    Express is a web app framework that sits on top of the Node.js server, adding extra functionality, such as, middleware support and routing.

2. Understand and explain the use of Middleware?

    Middleware are functions that have access to the req and res objects given to us by Express and the next() function.

3. The basic principles of the REST architectural style.

    - Everything is a resource
    - A resource can be accessed through a unique URI
    - Resources can have multiple representations
    - Communication is stateless and happens over protocol
    - Resources are managed through HTTP methods

4. Understand and explain the use of Express Routers.

    Express routers allow us to modularize an app into multiple pieces that are easier to read. They separate the logic for one resources route and management from another.
